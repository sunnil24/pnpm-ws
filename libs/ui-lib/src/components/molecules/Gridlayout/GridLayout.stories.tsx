...
Default.args = {
  ...
  children: (
    <>
      <Box style={{border:"1px solid black"}} width="9" height={"9"}>Item 1</Box>
      <Box style={{border:"1px solid black"}}  width="9" height={"9"}>Item 2</Box>
      <Box style={{border:"1px solid black"}}  width="9" height={"9"}>Item 3</Box>
      <Box style={{border:"1px solid black"}}  width="9" height={"9"}>Item 4</Box>
    </>
  ),
};
